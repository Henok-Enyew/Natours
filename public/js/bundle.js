    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Account Created successfully! Checkout Your Email and Get Verified!');
            // window.setTimeout(() => {
            //   location.assign('/');
            // }, 1000);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"chapa.js":[function(require,module,exports) {
var define;
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("https://natours-sbd8.onrender.com/api/v1/booking/checkout-session/".concat(tourId));
        case 3:
          ...
          _context.next = 7;
          return (0, _axios.default)("https://natours-sbd8.onrender.com/api/v1/booking/checkout-session/".concat(tourId) // `/api/v1/booking/checkout-session/${tourId}`,
          );
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          passwordConfirm = document.getElementById('password-confirm').value; // console.log(passwordCurrent);
          _context.next = 7;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4540" + '/');
